        ...
        <div class="flex items-center lg:order-2">
              ...
              <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <.gravatar
                    ...
                    email={@current_user.email |> Ash.CiString.to_comparable_string()}
                    alternate={@current_user.avatar}
          ...
          >
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              ...
              <a href="/sign-out" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                <svg
                  aria-hidden="true"
                  class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  fill="none"
          ...
          <div
            ...
            id="dropdown"
          >
            <div :if={@current_user.name || @current_user.email} class="py-3 px-4">
              <span :if={@current_user.name} class="block text-sm font-semibold text-gray-900 dark:text-white">
                <%= @current_user.name %>
              </span>
