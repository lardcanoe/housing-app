defmodule HousingAppWeb.CoreComponents do
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg-zinc-50/90 dark:bg-zinc-10/90 fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white dark:bg-slate-500 p-14 shadow-lg ring-1 transition"
            >
